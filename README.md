...
|-----------------------|--------------|----------------------------|
| `iris_analysis.Rmd`   | R Markdown   | Knit button in Positron, or `rmarkdown::render("iris_analysis.Rmd")` |
| `iris_analysis.qmd`   | Quarto       | Render button in Positron, or `quarto render iris_analysis.qmd`      |
...
2. Open `iris_analysis.qmd` (or `.Rmd`) and click **Render** (or **Knit**).
...
├── README.md
├── .gitignore
├── iris_analysis.Rmd   # R Markdown version
└── iris_analysis.qmd   # Quarto version
```
